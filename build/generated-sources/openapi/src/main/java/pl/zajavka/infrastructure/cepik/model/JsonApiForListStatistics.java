...
@JsonPropertyOrder({
  JsonApiForListStatistics.JSON_PROPERTY_DATA,
  JsonApiForListStatistics.JSON_PROPERTY_LINKS,
  JsonApiForListStatistics.JSON_PROPERTY_META
})
...
public class JsonApiForListStatistics implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private List<ApiAttributesDtoStatistics> data = null;
  ...
  public JsonApiForListStatistics() {
  }

  public JsonApiForListStatistics data(List<ApiAttributesDtoStatistics> data) {
    
    this.data = data;
    return this;
  }

  public JsonApiForListStatistics addDataItem(ApiAttributesDtoStatistics dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ApiAttributesDtoStatistics> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<ApiAttributesDtoStatistics> data) {
    this.data = data;
  }


  public JsonApiForListStatistics links(ApiLinksDto links) {
  ...
  **/
  ...
  public JsonApiForListStatistics meta(ApiMetaDto meta) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JsonApiForListStatistics jsonApiForListStatistics = (JsonApiForListStatistics) o;
    return Objects.equals(this.data, jsonApiForListStatistics.data) &&
        Objects.equals(this.links, jsonApiForListStatistics.links) &&
        Objects.equals(this.meta, jsonApiForListStatistics.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonApiForListStatistics {\n");
