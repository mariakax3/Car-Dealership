...
@JsonPropertyOrder({
  ApiAttributesDtoVehicle.JSON_PROPERTY_ATTRIBUTES,
  ApiAttributesDtoVehicle.JSON_PROPERTY_ID,
  ApiAttributesDtoVehicle.JSON_PROPERTY_LINKS,
  ApiAttributesDtoVehicle.JSON_PROPERTY_TYPE
})
...
public class ApiAttributesDtoVehicle implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ATTRIBUTES = "attributes";
  private VehicleDto attributes;
  ...
  public ApiAttributesDtoVehicle() {
  }

  public ApiAttributesDtoVehicle attributes(VehicleDto attributes) {
  ...
  **/
  ...
  public VehicleDto getAttributes() {
    return attributes;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ATTRIBUTES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(VehicleDto attributes) {
    this.attributes = attributes;
  }


  public ApiAttributesDtoVehicle id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unikalny identyfikator zasobu.")
  ...
  public ApiAttributesDtoVehicle links(ApiLinksOneDto links) {
  ...
  **/
  ...
  public ApiAttributesDtoVehicle type(String type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiAttributesDtoVehicle apiAttributesDtoVehicle = (ApiAttributesDtoVehicle) o;
    return Objects.equals(this.attributes, apiAttributesDtoVehicle.attributes) &&
        Objects.equals(this.id, apiAttributesDtoVehicle.id) &&
        Objects.equals(this.links, apiAttributesDtoVehicle.links) &&
        Objects.equals(this.type, apiAttributesDtoVehicle.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiAttributesDtoVehicle {\n");
