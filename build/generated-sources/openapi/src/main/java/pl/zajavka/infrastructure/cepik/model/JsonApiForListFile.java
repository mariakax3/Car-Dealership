...
@JsonPropertyOrder({
  JsonApiForListFile.JSON_PROPERTY_DATA,
  JsonApiForListFile.JSON_PROPERTY_LINKS,
  JsonApiForListFile.JSON_PROPERTY_META
})
...
public class JsonApiForListFile implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private List<ApiAttributesDtoFile> data = null;
  ...
  public JsonApiForListFile() {
  }

  public JsonApiForListFile data(List<ApiAttributesDtoFile> data) {
    
    this.data = data;
    return this;
  }

  public JsonApiForListFile addDataItem(ApiAttributesDtoFile dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ApiAttributesDtoFile> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<ApiAttributesDtoFile> data) {
    this.data = data;
  }


  public JsonApiForListFile links(ApiLinksDto links) {
  ...
  **/
  ...
  public JsonApiForListFile meta(ApiMetaDto meta) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JsonApiForListFile jsonApiForListFile = (JsonApiForListFile) o;
    return Objects.equals(this.data, jsonApiForListFile.data) &&
        Objects.equals(this.links, jsonApiForListFile.links) &&
        Objects.equals(this.meta, jsonApiForListFile.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonApiForListFile {\n");
