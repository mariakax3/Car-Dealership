...
@JsonPropertyOrder({
  JsonApiForListVehicle.JSON_PROPERTY_DATA,
  JsonApiForListVehicle.JSON_PROPERTY_LINKS,
  JsonApiForListVehicle.JSON_PROPERTY_META
})
...
public class JsonApiForListVehicle implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private List<ApiAttributesDtoVehicle> data = null;
  ...
  public JsonApiForListVehicle() {
  }

  public JsonApiForListVehicle data(List<ApiAttributesDtoVehicle> data) {
    
    this.data = data;
    return this;
  }

  public JsonApiForListVehicle addDataItem(ApiAttributesDtoVehicle dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ApiAttributesDtoVehicle> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<ApiAttributesDtoVehicle> data) {
    this.data = data;
  }


  public JsonApiForListVehicle links(ApiLinksDto links) {
  ...
  **/
  ...
  public JsonApiForListVehicle meta(ApiMetaDto meta) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JsonApiForListVehicle jsonApiForListVehicle = (JsonApiForListVehicle) o;
    return Objects.equals(this.data, jsonApiForListVehicle.data) &&
        Objects.equals(this.links, jsonApiForListVehicle.links) &&
        Objects.equals(this.meta, jsonApiForListVehicle.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonApiForListVehicle {\n");
