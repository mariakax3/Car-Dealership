...
public class CarServiceRequestEntityMapperImpl implements CarServiceRequestEntityMapper {
    ...
    @Override
    public CarServiceRequest mapFromEntity(CarServiceRequestEntity entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        carServiceRequest.carServiceRequestId( entity.getCarServiceRequestId() );
        carServiceRequest.carServiceRequestNumber( entity.getCarServiceRequestNumber() );
        carServiceRequest.receivedDateTime( entity.getReceivedDateTime() );
        carServiceRequest.completedDateTime( entity.getCompletedDateTime() );
        carServiceRequest.customerComment( entity.getCustomerComment() );

        return carServiceRequest.build();
    }

    @Override
    public CarServiceRequestEntity mapToEntity(CarServiceRequest request) {
        if ( request == null ) {
            return null;
        }
        ...
        carServiceRequestEntity.carServiceRequestId( request.getCarServiceRequestId() );
        carServiceRequestEntity.carServiceRequestNumber( request.getCarServiceRequestNumber() );
        carServiceRequestEntity.receivedDateTime( request.getReceivedDateTime() );
        carServiceRequestEntity.completedDateTime( request.getCompletedDateTime() );
        carServiceRequestEntity.customerComment( request.getCustomerComment() );
        carServiceRequestEntity.customer( customerToCustomerEntity( request.getCustomer() ) );
        carServiceRequestEntity.car( carToServiceToCarToServiceEntity( request.getCar() ) );
        carServiceRequestEntity.serviceMechanics( serviceMechanicSetToServiceMechanicEntitySet( request.getServiceMechanics() ) );
    ...
    protected ServiceMechanicEntity serviceMechanicToServiceMechanicEntity(ServiceMechanic serviceMechanic) {
        ...
        serviceMechanicEntity.carServiceRequest( mapToEntity( serviceMechanic.getCarServiceRequest() ) );
    ...
    protected ServicePartEntity servicePartToServicePartEntity(ServicePart servicePart) {
        ...
        servicePartEntity.carServiceRequest( mapToEntity( servicePart.getCarServiceRequest() ) );
