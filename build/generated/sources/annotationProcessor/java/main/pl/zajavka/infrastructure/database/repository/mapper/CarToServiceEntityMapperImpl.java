...
public class CarToServiceEntityMapperImpl implements CarToServiceEntityMapper {
    ...
    @Override
    public CarToService mapFromEntity(CarToServiceEntity entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        carToService.carToServiceId( entity.getCarToServiceId() );
        carToService.vin( entity.getVin() );
        carToService.brand( entity.getBrand() );
        carToService.model( entity.getModel() );
        carToService.year( entity.getYear() );

        return carToService.build();
    }

    @Override
    public CarToServiceEntity mapToEntity(CarToService car) {
        if ( car == null ) {
            return null;
        }
        ...
        carToServiceEntity.carToServiceId( car.getCarToServiceId() );
        carToServiceEntity.vin( car.getVin() );
        carToServiceEntity.brand( car.getBrand() );
        carToServiceEntity.model( car.getModel() );
        carToServiceEntity.year( car.getYear() );
        carToServiceEntity.carServiceRequests( carServiceRequestSetToCarServiceRequestEntitySet( car.getCarServiceRequests() ) );
    ...
    protected CarServiceRequestEntity carServiceRequestToCarServiceRequestEntity(CarServiceRequest carServiceRequest) {
        ...
        carServiceRequestEntity.car( mapToEntity( carServiceRequest.getCar() ) );
